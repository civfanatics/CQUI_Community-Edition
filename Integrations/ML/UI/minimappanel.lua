...
-- Additional CQUI Integration Last Updated Dec 2020 (the-m4a)
-- ===========================================================================
...
function SetMinimapForChat()
    -- sets the state of the minimap in WorldTracker to be used for chat resizing
    LuaEvents.WorldTracker_SetMinimapSize(Controls.MinimapContainer:GetSizeY() + 110);
end
...
function Initialize()
    ...
    -- Mod Lens Support
    -- CQUI does not include the ModLens configratuion item here for the ModLens settings menu
